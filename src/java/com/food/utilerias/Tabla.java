...
public class Tabla {
    ...
    private String abrirTabla(){
        ...
        String cab = "<table class='table table-hover table' id='"+estilo+"' style='width:"+ancho+";"+alin+"'>";
        return cab;
    }
        ...
        while (k<rst[0].length){             
           ...
           if (isEliminable()){
                ...
                if (getIconoEliminable().equals(""))
                    ...
                    enlaceEliminable = "<img title='Eliminar' src='" + this.pageContext + getIconoEliminable()+"'/>";               
                Tabla +="<td>"
